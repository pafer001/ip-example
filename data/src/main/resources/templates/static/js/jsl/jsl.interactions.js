    ...
    function validate() {
        ...
        try {
            ...
            if (result) {
                ...
                if (type == "1") {
                    textELE.val(JSON.stringify(result, null, "  "));
                } else {
                    textELE.val(JSON.stringify(result, null, ""));
                }
                ...
                resultELE.html("JSON 格式校验成功！");
                resultELE.removeClass("error");
                resultELE.addClass("success");
                $(".lineno").removeClass("lineselect");

            } else {
                resultELE.html("JSON 格式校验发生未知错误！");
            }
            ...
            **/
            ...
            resultELE.html(parseException);
            resultELE.removeClass("success");
            resultELE.addClass("error");
            ...
            if (lineMatches && typeof lineMatches === "object" && lineMatches.length > 1) {
                ...
                textELE.focus().caret(lineStart, lineEnd);
                $(".lineno:eq(" + --lineNum + ")").addClass("lineselect");
            }
